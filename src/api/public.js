...
export function getTrafficList(q) {
  return request.get("/article/traffic/", q, { login: false });
}

export function getRaidersList(q) {
  return request.get("/article/strategy/", q, { login: false });
}
